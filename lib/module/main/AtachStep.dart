...
Widget buildImagePreview(String path){
 return path==null? Icon(Icons.image,size: 200,color: Colors.grey,):
 Image.file(File(path),height: 200,fit: BoxFit.contain,);
          ...
          ButtonBar(
            children: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () {
                  documentPath=null;
                  atachPicture(context, "Documento", "DNI_");
                 },
              ),
            ],
          ),
          ...
          ButtonBar(
            children: <Widget>[
              ...
              FlatButton(
                ...
                onPressed: () {
                  beneficiarioPath=null;
                  atachPicture(context, "Beneficiario", "BENEFICIARIO_");
                 },
              ),
            ],
          ),
