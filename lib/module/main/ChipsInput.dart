...
class ChipsInput<T> extends StatefulWidget {
  ChipsInput({
    ...
    chipsInputState=new ChipsInputState(textOverflow);
  }
  ...
  ChipsInputState chipsInputState;
   Function updateValue(values){
     print("kajajajajjaja");
     print(values);
  chipsInputState.setChips(values);
  }
  @override
  ChipsInputState<T> createState(){
    return  chipsInputState;
...
class ChipsInputState<T> extends State<ChipsInput<T>>
  ...
  bool get _hasInputConnection => _connection != null && _connection.attached;
   void setChips(values){
       setState(() {
         _chips.addAll(values);
       });
